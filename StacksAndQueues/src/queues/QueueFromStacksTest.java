...
public class QueueFromStacksTest {
	...
	private QueueFromStacks<Integer> intQueue;
	private QueueFromStacks<String> stringQueue;
	...
	public void setUp() throws Exception {
		this.intQueue = new QueueFromStacks<Integer>();
		this.stringQueue = new QueueFromStacks<String>();
	}
	...
	public static void showPoints() {
		System.out.printf("QueueFromStacks implementation earned %d/13 points\n", points);
	}
}
