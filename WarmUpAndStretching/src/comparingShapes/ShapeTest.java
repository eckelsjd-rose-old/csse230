...
public class ShapeTest {
	...
	public void testSortCircles() {
		...
		// DONE: Nothing to change here. But note,
	...
	public void testSortTrianglesByPerimeter() {
		...
		// DONE: Nothing to write here. Just study this example. Note that we
	...
	public void testSortTrianglesByArea() {
		...
		// DONE: Create and add a comparator to compare triangles by area,
	...
	public void testSortTrianglesByAreaUsingTreeSet() {
		...
		// Do this as follows:
		// DONE: 1 Modify the next line to create a new TreeSet - use the version
		// of the constructor that takes a
		// comparator, and pass the same comparator you wrote for the last test.
		TreeSet<Triangle> triangleSet = new TreeSet<>(new Comparator<Triangle>() {
			@Override
			public int compare(Triangle first, Triangle second) {
				return (int) Math
						.signum(first.area() - second.area());
		...
		// DONE: 2 Iterate through the unsorted triangles array, adding the
		// triangles
		// to the TreeSet.
		...
		// DONE: 3 Iterate through the TreeSet using a foreach loop (Java's
