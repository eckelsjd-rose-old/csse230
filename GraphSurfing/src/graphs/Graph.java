...
public abstract class Graph<T> {
	...
	/**
	 * Returns an Iterator that traverses the keys who are predecssors of the given key.
	 * @param key
	 * @return
	 * @throws NoSuchElementException if the key is not found in the graph
	 */
	...
	// depth-first search
	public abstract boolean dfs(T from, T to);
	
	// breadth-first search
	public abstract boolean bfs(T src, T dest);
}
